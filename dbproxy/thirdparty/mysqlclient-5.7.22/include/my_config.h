...
#define DEFAULT_MYSQL_HOME "/data/mysql"
#define SHAREDIR "/data/mysql/share"
#define DEFAULT_BASEDIR "/data/mysql"
#define MYSQL_DATADIR "/data/mysql"
#define MYSQL_KEYRINGDIR "/usr/local/mysql/keyring"
#define DEFAULT_CHARSET_HOME "/data/mysql"
#define PLUGINDIR "/data/mysql/lib/plugin"
